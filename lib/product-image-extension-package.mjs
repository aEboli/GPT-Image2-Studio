...
const EXPECTED_LAUNCHER_SCRIPTS = ["collector.js", "floating-launcher.js", "floating-panel.js"];
...
function validateManifest(manifest) {
  ...
  const hasExactLauncher = contentScripts.length === 1 &&
    ...
    Array.isArray(launcher.js) &&
    JSON.stringify(launcher.js) === JSON.stringify(EXPECTED_LAUNCHER_SCRIPTS) &&
