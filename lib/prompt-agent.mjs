      ...
      items: {
        ...
        properties: {
          ...
          color_names: {
            ...
            maxItems: 20,
            items: { type: "string" },
            description: "Exactly one concise English colorway name per complete visible product unit, ordered left-to-right or top-to-bottom. Read the dominant physical product color, not the background, overlay text, lighting, or shared neutral trim; distinguish close variants such as navy blue versus cyan/sky blue and orange versus red.",
          },
          note: {
            type: "string",
    ...
    ? value
        .map((item, index) => {
          ...
          return {
            ...
            ...(colorNames.length > 0 ? { color_names: colorNames } : {}),
            note,
          };
        })
        .filter(Boolean)
