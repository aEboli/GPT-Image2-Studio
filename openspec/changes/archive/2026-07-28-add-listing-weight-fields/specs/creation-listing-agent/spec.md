...
- **WHEN** any Listing is copied as full text or exported as structured JSON
- **THEN** package and product weight fields appear after the two dimension fields in English and Simplified Chinese
