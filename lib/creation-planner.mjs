...
export const CREATION_ITEM_ROLES = [
  {
    ...
    title: "首图成交主视觉",
    filenameToken: "hero",
    brief: "conversion-first hero image with the product as the dominant subject, one main buying promise, and 2-3 trustworthy supporting cues",
  },
  {
    role: "benefit",
    title: "核心信息融合图",
  ...
  },
  {
    ...
    title: "品牌质感/礼品价值图",
    filenameToken: "brand",
    brief: "brand texture and gift-value image that turns supplied craft, ritual, packaging, origin, or taste cues into premium perceived value",
  },
  {
  ...
  },
  {
    ...
    brief: "after-sales trust closing image that reduces final ordering risk with only supplied service, support, shipping, warranty, or return facts",
  },
  {
    role: "usage-suggestion",
    title: "使用步骤/上手图",
    filenameToken: "tips",
    brief: "use-and-owning confidence image with practical setup, operation, care, or first-use steps that make ownership feel easy",
  },
];
...
const CREATION_ROLE_INTENT_INSTRUCTIONS = {
  hero:
    "Role intent: create the first decision frame. Make product identity, category, primary promise, and immediate buyer relevance readable within one glance; use only one main claim and a few supplied support cues.",
  benefit:
...
const CREATION_SHOPPER_QUESTION_ROLE_INSTRUCTIONS = {
  ...
  "brand-story":
    "SHOPPER QUESTION: does this feel like the right quality, taste, or gift value for me? Answer with supplied craft, ritual, packaging, material, origin, or positioning cues without inventing brand history.",
  "size-capacity-fit":
  ...
  "after-sales":
    "SHOPPER QUESTION: what risk is reduced after ordering? Answer with only supplied service, support, shipping, warranty, refund, exchange, or quality-assurance facts.",
  "usage-suggestion":
    "SHOPPER QUESTION: will I know how to use it successfully? Answer with practical setup, first-use, operation, care, or mistake-prevention steps while preserving the actual product.",
};
...
const CREATION_BUYER_DECISION_ROLE_INSTRUCTIONS = {
  ...
  "brand-story":
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: whether this product fits my values, taste, or intended gift. Turn supplied craft, origin, material, ritual, or brand-position facts into shopper value without inventing brand claims.",
  "effect-comparison":
  ...
  "after-sales":
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: what risk remains after I click buy. Reduce final hesitation with only supplied service, warranty, refund, exchange, shipping, support, or quality-assurance facts.",
  "usage-suggestion":
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: will I know how to use it successfully. Show setup, operation, care, or use steps that reduce anxiety and make ownership feel easy while preserving the actual product.",
};
...
const CREATION_ROLE_CONTENT_CATEGORIES = {
  ...
  "brand-story": ["material", "package", "trust", "visible-copy"],
  ...
  "usage-suggestion": ["usage", "scene", "trust"],
};
...
const CREATION_VISUAL_BLUEPRINT_REFERENCE_ROLES = new Set(["usage", "scene"]);
...
function buildCreationReferenceCoverageSourceInstruction(source = {}) {
  ...
  if (role === "usage") {
    return `Usage source ${filename} is a visual blueprint: faithfully reconstruct the original instruction card, demonstration frame, hand/action setup, panels, arrows, and operation flow first, preserve the original sequence, then recompose it around the current product and selected visual language. Do not invent different steps, do not add steps not present in the source, and do not turn the note into new labels.`;
  }
  return "";
}
