...
- **WHEN** the model returns a Listing that passes parsing, normalization, minimum bilingual structure, evidence-term sanitization, and blocking-claim sanitization
