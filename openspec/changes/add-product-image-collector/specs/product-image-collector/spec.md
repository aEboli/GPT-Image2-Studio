...
- **WHEN** the user clicks the launcher and the runtime throws, reports an error, or does not answer within the bounded open timeout
- **THEN** the launcher becomes enabled again and exposes the failure instead of remaining permanently disabled
