export const CREATION_PLATFORM_POLICY_VERSION = "2026-07-18.2";
...
export const CREATION_PLATFORM_RESOLUTION_TIERS = Object.freeze(["1K", "1.5K", "2K", "max"]);
...
const IMAGE_TYPE_DEFINITIONS = [
  ...
  imageType(
    ...
    "forbid-overlay",
    {
      ...
      constraints: [
        ...
        blockingConstraint("amazon-main-studio-white", "scenePolicy", "equals", "studio-white", "amazon-g1881", "Amazon 主图必须保持纯白棚拍背景，不得使用生活场景或场景道具。"),
  ...
  imageType("scene-application", "适用多场景图", "scene", "multi-scenario-application", "concise", "authentic-use", "allow-supplied"),
  imageType("ownership-atmosphere", "冲动下单氛围图", "atmosphere", "ownership-atmosphere", "concise", "authentic-lifestyle", "allow-supplied"),
  imageType("use-style-story", "品牌质感与使用风格图", "brand-story", "multi-scene-use-style-story", "moderate", "multi-context", "allow-supplied"),
  imageType(
    "target-shopper-resonance",
    "目标人群共鸣图",
    "benefit",
    "target-shopper-decision-moment",
    "concise",
    "authentic-use",
    "allow-supplied",
  ),
  ...
  imageType("spec-table", "参数表", "spec-table", "product-led-key-spec-callouts", "factual-only", "neutral", "allow-supplied"),
  ...
  imageType("wearable-demo", "真人穿戴场景图", "human-wearable", "person-wearing-or-carrying", "concise", "authentic-use", "allow-supplied"),
  imageType("in-box", "包装清单图", "accessory-gift", "unpacked-included-items-flat-lay", "factual-only", "studio-clean", "allow-supplied"),
...
const PROFILE_DEFINITIONS = [
  ...
  profile(
    ...
    ["clean-catalog-main@1:1", "content-cover@3:4", "creator-demo@3:4", "lifestyle-first@3:4", "detail-macro@1:1", "dimension-fit@1:1"],
  ),
  profile(
    "xiaohongshu",
    "小红书电商",
  ...
  profile(
    ...
    ["tiktok-shop-main@1:1", "creator-demo@1:1", "lifestyle-first@1:1", "benefit-proof@1:1", "detail-macro@1:1", "dimension-fit@1:1"],
  ),
  profile(
    "shopee",
    "Shopee",
  ...
  profile(
    ...
    ["brand-hero@1:1", "clean-product-proof@1:1", "lifestyle-first@1:1", "benefit-proof@1:1", "detail-macro@1:1", "usage-demo@1:1", "dimension-fit@1:1", "brand-trust@1:1"],
  ),
  profile(
    "aliexpress",
    "AliExpress",
  ...
  profile(
    ...
    ["clean-catalog-main@1:1", "info-benefit@1:1", "detail-macro@1:1", "spec-table@1:1", "usage-demo@1:1", "gift-packaging@1:1", "dimension-fit@1:1", "in-box@1:1"],
  ),
  profile(
    "coupang",
    "Coupang",
...
export const CREATION_PLATFORM_OPTIONS = deepFreeze(
  CREATION_PLATFORM_PROFILES.map((entry) => ({
    ...
    defaultRatio: entry.defaultRatio,
