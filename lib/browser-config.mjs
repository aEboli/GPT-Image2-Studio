...
export function normalizeBrowserPrivateConfig(source = {}, { preserveRootBaseUrls = false } = {}) {
  ...
  return {
    ...
    imageToolModel: routeConfig.imageToolModel || DEFAULT_IMAGE_TOOL_MODEL,
    includeImageToolModel: routeConfig.includeImageToolModel,
...
export function toPublicBrowserConfig(privateConfig, baseConfig = {}) {
  ...
  return {
    ...
    imageToolModel: normalized.imageToolModel,
    ...
    directImageStream: normalized.directImageStream,
  ...
  const next = normalizeBrowserPrivateConfig(
    {
      ...
      directImageStream: payload.directImageStream === undefined
        ? current.directImageStream
        : normalizeDirectImageStream(payload.directImageStream),
...
export function appendBrowserConfigToFormData(formData, readConfig = readBrowserPrivateConfig, overrides = {}) {
  ...
  formData.set("imageToolModel", config.imageToolModel);
  formData.set("includeImageToolModel", String(config.includeImageToolModel));
  ...
  formData.set("directImageStream", String(config.directImageStream));
...
export function getBrowserPrivateConfigRequestPayload(readConfig = readBrowserPrivateConfig) {
  ...
  return browserConfig
    ? {
        ...
        directImageStream: browserConfig.directImageStream,
