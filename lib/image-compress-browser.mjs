...
export async function compressImageFile(file, options = {}) {
  ...
  try {
    ...
    const outputBlob = normalizedOptions.outputFormat === "original" && !normalizedOptions.resizeEnabled && encoded.blob.size > file.size
      ? file
      : encoded.blob;
    ...
    return {
      ...
      ratio: calculateCompressionRatio(file.size, outputBlob.size),
      blob: outputBlob,
      url: resultUrl,
