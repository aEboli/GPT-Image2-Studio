...
export function createProductImageImportController({
  ...
  const refs = {
    ...
    selectNoneButton: documentRef.querySelector("#productImageImportSelectNoneButton"),
  ...
  function syncCounts() {
    ...
    if (refs.selectNoneButton) refs.selectNoneButton.disabled = selectionDisabled;
  ...
  function bind() {
    ...
    refs.selectNoneButton?.addEventListener("click", () => applyBatchSelection("none"));
