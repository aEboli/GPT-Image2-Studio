...
export const API_RUNTIME_CAPABILITIES = Object.freeze([
  ...
  },
  {
    ...
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Cloudflare cannot package the locally distributed browser extension.",
  },
  {
    method: "POST",
  ...
  {
    method: "POST",
    path: "/api/portrait/sets/delete",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.SUPPORTED,
    reason: "Cloudflare treats Portrait record deletion as idempotent because it has no server-side set store.",
  },
  {
    method: "POST",
  ...
  {
    method: "GET",
    path: "/api/article-illustration/sets",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Article illustration records depend on local set manifests and output files.",
  },
  {
    method: "POST",
    path: "/api/article-illustration/sets/delete",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Article illustration record deletion depends on local set manifests and output files.",
  },
  {
    method: "POST",
    path: "/api/article-illustration/plan",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Article illustration planning currently depends on the local set store.",
  },
  {
    method: "POST",
    path: "/api/article-illustration/generate-references",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Article reference generation currently depends on local set manifests and output files.",
  },
  {
    method: "POST",
    path: "/api/article-illustration/generate",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Article illustration generation currently depends on local set manifests and output files.",
  },
  {
    method: "POST",
  ...
  {
    method: "POST",
    path: "/api/creation/sets/delete",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.SUPPORTED,
    reason: "Cloudflare treats Creation record deletion as idempotent because it has no server-side set store.",
  },
  {
    method: "POST",
    path: "/api/creation/sets/export-temu-excel",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.UNSUPPORTED,
    reason: "Temu Excel export depends on local Creation manifests, template files, and local output images.",
  },
  {
    method: "POST",
  ...
  {
    method: "POST",
    path: "/api/ppt/decks/delete",
    local: API_RUNTIME_STATUS.SUPPORTED,
    cloudflare: API_RUNTIME_STATUS.SUPPORTED,
    reason: "Cloudflare treats PPT record deletion as idempotent because it has no server-side deck store.",
  },
  {
    method: "POST",
