...
[![Version](https://img.shields.io/badge/version-v0.2.2-2563eb.svg)](https://github.com/aEboli/GPT-Image2-Studio/releases)
...
| 套图记录 | `#creation-record`，资产 -> 套图记录 | 商品/平台搜索、已保存套图 | 恢复生成快照、有效计划、进度、Listing 和逐图结果 | 导出 TXT/JSON、按冻结计划补齐缺失项、查看灯箱和下载 |
...
```text
GPT-Image2-Studio-Setup-v0.2.2.exe
```
