...
function getCreationDimensionGroupMatchesSubject(
  ...
  return (Array.isArray(dimensionGroups) ? dimensionGroups : []).filter((group) => {
    ...
    const groupIndexes = normalizeNumberArray(group.referenceIndexes);
    const groupFilenames = new Set(uniqueCleanStrings(group.filenames).map((value) => value.toLowerCase()));
    return (
