...
export const CREATION_REFERENCE_ROLE_OPTIONS = [
  ...
  },
  {
    ...
    promptInstruction: "Use it to read package-list content, bundle contents, included accessories, quantities, and what the shopper receives. In a package/list image, show confirmed packaging only as a separate secondary inventory item beside unpacked contents; never use a box or container as the default stage. In other roles, do not copy package-box exterior appearance.",
  },
  {
    value: "material",
    label: "结构细节",
...
export const CREATION_ITEM_ROLES = [
  {
    ...
    title: "首图成交主视觉",
    filenameToken: "hero",
    brief: "conversion-first hero image with the product as the dominant subject, one main buying promise, a complete bounded hierarchy of reliable non-dimension facts, and multiple small circular scene frames",
  },
  {
    role: "benefit",
    title: "目标人群共鸣图",
    filenameToken: "benefit",
    brief: "target-shopper resonance image that places the exact product in one recognizable buyer situation, mirrors a concrete need or pain point, and creates an emotionally credible reason to choose it",
  },
  {
    role: "scene",
    title: "适用多场景图",
  ...
  },
  {
    ...
    title: "冲动下单氛围图",
    filenameToken: "mood",
    brief: "decisive-moment impulse-buy atmosphere image that makes the exact product feel urgently useful or emotionally wanted in a specific ownership or usage moment while keeping it clear, close, and commercially inspectable",
  },
  {
    role: "product-detail",
    title: "产品细节特写图",
  ...
  },
  {
    ...
    brief: "single-product functional effect rendering with one fully visible, dominant product showing every supported function, mechanism, effect path, or outcome through premium ecommerce 3D/CGI or cinematic product visualization",
  },
  {
    role: "spec-table",
    title: "参数规格图",
    filenameToken: "specs",
    brief: "product-led key-specification explainer with the product as the main visual, accurate measurement callouts, and no more than four distinct decision-relevant attributes",
  },
  {
    role: "craft-process",
    title: "品质工艺证明图",
  ...
  },
  {
    ...
    brief: "unpacked included-items and accessory checklist showing the product and every supplied item fully visible on a clean open surface outside any packaging container",
  },
  {
...
export const CREATION_SCENARIO_ROLE_INSTRUCTIONS = {
  ...
  "detail-page": {
    ...
    "spec-table":
      "Role focus: turn a few key parameters into a product-led annotated explanation rather than a dense data table or decorative copy.",
    benefit:
      "Role focus: create one target-shopper resonance moment inside the detail page: show a recognizable buyer, one concrete pre-purchase hesitation or need, and the exact product becoming the emotionally credible choice. Do not repeat the later selling-point module.",
    "usage-suggestion":
  ...
  "social-seeding": {
    ...
    benefit:
      "Role focus: make one recognizable target shopper feel seen in a specific everyday need or frustration, with the exact product naturally becoming the choice; avoid a feature-card or selling-point stack.",
    atmosphere:
      "Role focus: capture a decisive ownership or usage instant whose mood, visible action, target-user cue, and lifestyle aspiration make the product feel immediately wanted without hiding it; do not settle for a flat styled still life.",
    "usage-suggestion":
  ...
  launch: {
    ...
    benefit:
      "Role focus: express the launch through one target shopper recognizing that this product fits a concrete need or moment; keep the person-situation-product relationship stronger than any feature list.",
    "accessory-gift":
  ...
  promotion: {
    ...
    "effect-comparison":
      "Role focus: make the supported product value easy to understand through one dominant product in a unified functional rendering, without before-after or comparison layouts.",
    "after-sales":
  ...
  livestream: {
    ...
    benefit:
      "Role focus: give the host one target-shopper resonance moment to describe: who needs it, which familiar situation triggers interest, and why the product becomes the credible choice; leave the selling-point stack to its own role.",
    "usage-suggestion":
  ...
  "marketplace-search": {
    ...
    benefit:
      "Role focus: make the intended shopper and one familiar need or decision moment readable at search-card speed, with the product visibly resolving that moment; avoid a second selling-point poster.",
    "effect-comparison":
      "Role focus: make one dominant product and its supported functional effect instantly readable in crowded search result pages with a unified visual hierarchy and no comparison panels.",
    "size-capacity-fit":
...
const CREATION_ROLE_INTENT_INSTRUCTIONS = {
  hero:
    "Role intent: create the first decision frame and the complete ecommerce sales anchor. Make product identity, category, primary promise, and every reliable non-dimension product fact, material, usage, package, trust cue, and selling point that fits a clear hierarchy readable at a glance; merge the facts into concise target-language copy instead of scattering them across later cards. Add 3-5 small circular scene frames around the dominant product to show believable use contexts; for tools, vary task environments such as home repair, workshop, outdoor, vehicle, or jobsite use; for apparel, show a live model wearing the exact item across suitable occasions such as commute, casual outing, travel, or daily styling. Preserve exact supplied numbers only as non-size identifiers or units; reserve measurements and weight for dimension/specification roles.",
  benefit:
    "Role intent: create a target-shopper resonance frame, not a second selling-point card. Show one recognizable target person or buyer viewpoint, one concrete pre-purchase need, frustration, or hesitation, and the exact product entering that decisive moment as the emotionally credible choice. Make the viewer feel understood and ready to choose; use at most one short supporting proof cue, and do not render a generic feature list, dense information board, parameter table, or plain product-only card.",
  scene:
  ...
  atmosphere:
    "Role intent: make the product feel immediately wanted in a decisive ownership or usage instant. Show a visible action, target-user cue, specific environment, and emotional trigger such as relief, readiness, confidence, delight, gifting urgency, or a just-in-time need while the exact product remains recognizable and commercially inspectable. Give the image persuasive advertising energy; it must feel like a purchase-triggering moment, not a flat static display, empty decorative mood, unrelated lifestyle scene, or rigid template board.",
  "product-detail":
  ...
  "effect-comparison":
    "Role intent: create one product-led functional effect rendering in a single unified composition. Keep one dominant, fully visible product as the visual anchor. Show every supported product function, mechanism, effect path, or outcome listed in FUNCTION COVERAGE LOCK with dimensional arrows, cutaway-style overlays, motion trails, energy or material-flow cues, and premium 3D/CGI rendering when useful. If the coverage cannot remain legible in one frame, use a seamless continuous scene stitch around the same unchanged product and preserve every listed function; never turn the stitch into comparison cards. Do not use before-and-after, comparison, side-by-side, split-screen, paired-state, duplicate-product, or independent multi-panel layouts. Do not invent unsupported technical structures, performance numbers, certifications, or effects.",
  "spec-table":
    "Role intent: create a product-led key-spec explanation. Keep the product visually dominant, select only a few distinct decision-relevant specifications, and connect each visible value to a product part, capacity, scale, or fit cue instead of filling rows and columns.",
  "craft-process":
  ...
  "accessory-gift":
    "Package inventory lock: make this a complete accessory and gift checklist image. If a package/list reference is supplied, use that package reference as the inventory authority. Show every distinct visible included item and quantity from the supplied checklist or package facts; do not summarize, crop, merge, omit, or replace checklist entries with generic kit contents. UNPACKED INVENTORY LAYOUT: separate the main product and each confirmed accessory, gift, or included component on a clean open surface, fully visible outside any box, tray, case, bag, or container. Keep the full set readable in one clear layout, even if that requires smaller product thumbnails, a two-column list, or a structured grid.",
  "series-showcase":
...
const CREATION_ROLE_RENDERING_CONSTRAINTS = {
  ...
  "effect-comparison":
    "For this functional effect rendering, keep one dominant, fully visible product in one unified composition and show every FUNCTION COVERAGE LOCK cue around that same product. If simultaneous clarity is impossible, use a seamless continuous scene stitch around the same unchanged product with blended environmental transitions, no hard panel borders, and no omitted coverage item. Do not use before-and-after, comparison, side-by-side, split-screen, paired-state, duplicate-product, independent cards, or comparison panels.",
  "spec-table":
    "For this specification image, use only supplied parameters and keep the product as the dominant visual subject. Anchor visible values with measurement lines, local callouts, or 2-4 compact explanatory modules. Do not create a full-canvas data table, spreadsheet, database-like grid, or dense wall of rows. Do not invent model numbers, certifications, test results, or unsupported values.",
  "accessory-gift":
    "For this accessory and gift image, use an UNPACKED INVENTORY LAYOUT and prioritize complete inventory coverage over lifestyle styling: separate the main product and every confirmed item on a clean open surface, fully visible outside any box, tray, case, bag, or container. Do not crop the list, omit bottom rows, show a representative subset only, or hide quantities. Do not add or use a cardboard box, shipping carton, paper tray, blister tray, molded insert, or generic retail packaging. Show packaging only when supplied evidence explicitly confirms it is included, and then show it as a separate secondary inventory item beside the unpacked contents rather than placing everything inside it.",
  "ingredient-material":
...
const CREATION_SHOPPER_QUESTION_ROLE_INSTRUCTIONS = {
  hero:
    "SHOPPER QUESTION: what is this product and why should I care at first glance? Answer with unmistakable product identity, one main buying promise, and every reliable non-dimension fact that can fit a clear ecommerce hierarchy; condense and group the evidence instead of limiting the hero to 2-3 support points.",
  benefit:
    "SHOPPER QUESTION: which target shopper will feel understood by this product right now? Answer with one recognizable buyer, one concrete need, frustration, or hesitation, and one emotionally credible reason the exact product becomes the choice; do not repeat a selling-point stack.",
  scene:
  ...
  atmosphere:
    "SHOPPER QUESTION: what decisive moment would make me want to buy this now? Answer with a visible action, target-user cue, concrete environment, and purchase-trigger emotion around the exact product, not abstract mood, flat display, or unrelated decoration.",
  "product-detail":
  ...
  "effect-comparison":
    "SHOPPER QUESTION: can I see everything this product function actually does? Answer with one unified product-led functional rendering that shows every supported function, mechanism, effect path, or outcome from supplied facts.",
  "spec-table":
    "SHOPPER QUESTION: which few key specifications affect my choice, and where do they apply on the product? Answer with exact supplied values anchored to the visible product through measurement lines, local callouts, or compact explanatory modules, not a data-only table.",
  "craft-process":
  ...
  "accessory-gift":
    "SHOPPER QUESTION: what exactly comes with this product? Answer with a complete unpacked checklist of supplied quantities and included accessories or gift components, all separated and fully visible outside packaging.",
  "series-showcase":
...
const CREATION_BUYER_DECISION_ROLE_INSTRUCTIONS = {
  benefit:
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering which pain point disappears and which outcome improves. Make the target shopper feel recognized at a concrete pre-purchase decision moment. Show who the buyer is, which familiar need or hesitation is present, and why the exact product becomes the emotionally credible choice; reserve 3-5 explicit selling points for the separate 卖点图 role.",
  "multi-angle":
  ...
  atmosphere:
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: can I imagine owning this in my life. Build a believable ownership or usage instant in the moment that desire becomes action, with visible action, target-user empathy, specific environment, and a concrete trigger such as relief, readiness, confidence, delight, gifting urgency, or a just-in-time need; avoid pure mood, flat product display, abstract lifestyle, or decorative ambience.",
  "brand-story":
  ...
  "effect-comparison":
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: can I see the functional effect clearly enough to believe the value and understand every supported feature. Make one unified rendering around one dominant, fully visible product, showing each supported function, mechanism, effect path, or outcome from supplied facts; premium 3D/CGI rendering is allowed when it makes the effect easier to understand.",
  "craft-process":
  ...
  "accessory-gift":
    "BUYER DECISION STRATEGY: help a shopper decide whether to buy by answering: what exactly arrives and does it feel complete. Make bundle completeness, item identity, quantities, gift readiness, and value stack visible without replacing the supplied inventory or using an invented box as the composition.",
  "series-showcase":
...
function buildCreationDimensionPromptInstruction({
  ...
  if (cleanString(role) === "spec-table") {
    if (!dimensionSpecSummary) {
      return `${dimensionUnitMode.promptInstruction} No exact supplied specification value is available for this image. Keep the product as the dominant visual subject and use only non-numeric visible structure, scale, capacity, or fit cues. Do not create placeholder rows, guessed values, rulers, a full-canvas data table, spreadsheet, database-like grid, or dense wall of rows.`;
    }

    const dualUnitLock =
      dimensionUnitMode.value === "both"
        ? "Both-unit lock: the metric and imperial pair must appear in the same visible label for every selected specification, for example Length 10 cm (3.94 in). Never show only one half of a supplied pair."
        : "";
    return [
      `KEY SPECIFICATION SELECTION: Visible key specifications: ${dimensionSpecSummary}.`,
      "Use only these curated values in this specification image. Show no more than 4 distinct purchase-relevant attributes and at most one visible value for each attribute label; do not reintroduce additional or repeated measurements from source notes.",
      dimensionUnitMode.promptInstruction,
      dualUnitLock,
      buildCreationExactNumericValueLock(dimensionSpecSummary),
      "PRODUCT-LED SPECIFICATION LAYOUT: keep the product as the dominant visual subject and anchor each visible specification to the relevant product part, capacity, scale, or fit cue with measurement lines, local callouts, or 2-4 compact explanatory modules.",
      "Do not create a full-canvas data table, spreadsheet, database-like grid, or dense wall of rows. Do not invent missing parameters, model numbers, certifications, test results, performance explanations, or unsupported values.",
      source === "reference"
        ? "These key specifications were recognized from reference notes; copy them exactly but treat all unselected reference measurements as evidence-only and do not render them."
        : "These key specifications came from user input; copy them exactly but treat all unselected supplied measurements as evidence-only and do not render them in this image.",
    ]
      .filter(Boolean)
      .join(" ");
  }
  ...
  return `${dimensionUnitMode.promptInstruction} Apply this selected unit mode only to length, height, width, depth, and weight values recognized from dimension/specification reference images or analyst notes. Do not invent missing measurements; only render size or weight values visible in the supplied references or explicitly provided by the user. When no exact measurement is supplied, keep this as a non-numeric scale or fit image grounded in visible product structure and omit rulers, dimension lines, numeric callouts, and guessed comparison-object sizes.`;
}
...
function getCreationPlatformRoleInstruction(roleValue) {
  const role = cleanString(roleValue);
  if (role === "hero") {
    return "Role platform adaptation: make the opening image thumbnail-legible, instantly identifiable, and suitable for the selected platform's first buyer impression.";
  }
  if (role === "spec-table" || role === "size-capacity-fit") {
    return "Role platform adaptation: make hard facts comparison-ready, readable at marketplace detail size, and strictly limited to supplied dimensions, capacities, compatibility, or parameters.";
  }
  if (role === "benefit" || role === "usage-suggestion" || role === "after-sales") {
    return "Role platform adaptation: connect each visual proof point to buyer intent on the selected platform, using only supplied benefits, pain points, and product evidence.";
  }
  if (role === "sku" || role === "series-showcase") {
    return "Role platform adaptation: keep SKU, bundle, color, quantity, and variant evidence easy to compare for platform shoppers without inventing unprovided options.";
  }
  if (role === "infographic-rebuild") {
    return "Role platform adaptation: preserve source information while making the rebuilt detail image readable and useful inside the selected platform's product-gallery flow.";
  }
  return "Role platform adaptation: choose composition density, proof style, and visible text hierarchy for the selected platform and this specific product category.";
}
...
function buildCreationPlatformPromptInstruction(platform, industryTemplate, roleValue) {
  ...
  return [
    `PLATFORM FIT ANALYSIS: Platform: ${normalizedPlatform.label}. Product category/type: ${categoryText}.`,
    normalizedPlatform.promptInstruction,
    getCreationPlatformRoleInstruction(roleValue),
    "Analyze the product facts, category expectations, SKU structure, dimensions, and reference-image evidence before composing; adapt layout, copy density, proof emphasis, and scene choice to that platform/category combination.",
  ]
    .filter(Boolean)
    .join(" ");
}
...
function buildCreationVisualLanguageGuidance(visualLanguage) {
  ...
  return [
    ...
    isDefaultClassic
      ? "Do not drift into lifestyle editorial, social UGC, premium studio drama, or unrelated ad poster styles unless explicitly selected."
...
function buildCreationSkuMainSubjectLock(skuSubject = {}) {
  ...
  return [
    ...
    "Do not substitute another product reference, colorway, accessory, package image, scene object, or newly invented product as the SKU subject.",
  ].join(" ");
}
...
function buildCreationSkuColorNameInstruction({ skuSubject, targetLanguage } = {}) {
  ...
  return [
    ...
    subjectUnitCount > 1
      ...
      : "Add one short pure-color label directly below the product subject, centered under the subject and separated from any source-card overlays.",
    targetLanguage?.value === "en"
      ? "Translate the complete label into English when needed."
      : "Translate the complete label into the selected target language when needed.",
    "Color-label text may contain color names, spaces, and internal hyphens only. Separate independent colors with single spaces. Preserve a hyphen that belongs inside a recognized compound color name such as off-white. Do not render commas, quotation marks, slashes, brackets, bullets, hyphens used as color separators, or any other punctuation in a color label. Do not add part names such as strap, frame, or lenses, and do not add materials, finishes, styles, model identifiers, product names, sizes, marketing words, or other non-color text.",
    "Keep all supplied colors together in one label for each complete product unit, including shared neutral colors, but omit every associated non-color qualifier and disallowed punctuation mark.",
    groupedColorLabels
      ? `Visible SKU color label lines for the grouped subject follow in product-unit order.\n${groupedColorLabels}\nPreserve every complete label line and place only its color words below the corresponding visible product unit.`
      : colorName
      ? `Visible SKU color label line under the subject follows.\n${colorName}\nRender that exact color-only line below the product subject with no other words or disallowed punctuation.`
      : "The exact SKU color name is unavailable. Do not render any color-name label and never guess one from the background, source-card text, lighting, shadow, highlight, or environmental reflection.",
    subjectUnitCount > 1
...
function buildCreationSkuReferenceScopeInstruction(skuGenerationRule) {
  ...
  if (rule.includePackageList || rule.includeDimensions) {
    return [
      ...
      "Ignore accessory-only, material-only, and scene references when composing this SKU image.",
    ].join(" ");
  }
  return "Ignore accessory-only, packaging-only, dimension-only, material-only, and scene references when composing this SKU image.";
}
...
function buildCreationPrimarySubjectLock(referenceImageRoles = []) {
  ...
  return [
    ...
    hasOtherProductSubjects
      ...
      : "",
    "Supporting references may influence only their assigned role constraints, background, scene, dimensions, usage, material, or package; they must not become the main sellable product subject.",
  ]
    .filter(Boolean)
    .join(" ");
}
...
function collectCreationFunctionalCoverageFacts(allocation, referenceImageRoles = []) {
  ...
  const referenceFacts = (Array.isArray(referenceImageRoles) ? referenceImageRoles : [])
    .filter((entry) => ["usage", "material"].includes(cleanString(entry?.role)))
...
function buildCreationFunctionalCoverageGuidance(allocation, referenceImageRoles = []) {
  ...
  if (!coverage) {
    return "FUNCTION COVERAGE LOCK: No specific supported function fact was supplied. Show only the product's visibly supported mechanism or effect cues; do not invent a function.";
  }
  return `FUNCTION COVERAGE LOCK: Cover every supplied function, mechanism, effect path, or outcome in this list, without omission: ${coverage}. Use the list as evidence only; do not invent extra functions, numbers, certifications, or outcomes. If one frame cannot keep all listed functions legible, use a seamless continuous scene stitch around the same unchanged product, with no hard panel borders and no comparison semantics.`;
}
...
function buildCreationHeroInformationCoverageGuidance(allocation, referenceImageRoles = []) {
  ...
  if (!coverage) {
    return "HERO INFORMATION COVERAGE LOCK: No reliable non-dimension product facts were supplied beyond the product identity. Keep the hero product-first, use only supplied evidence, and do not invent marketing claims.";
  }
  return `HERO INFORMATION COVERAGE LOCK: Merge every reliable non-dimension product fact in this list into one clear ecommerce information hierarchy, without omission: ${coverage}. Turn added marketing copy into the selected target language, group related facts into concise headline, proof, package, material, use, and trust layers, and retain 3-5 small circular scene frames around the same dominant product. Do not translate text already physically printed on the supplied product or package. Exclude measurements and weight; reserve them for dimension/specification roles. Do not invent extra facts, numbers, certifications, claims, package contents, or outcomes.`;
}
...
function buildCreationTargetLanguageTextGuidance(targetLanguage) {
  ...
  return [
    "Treat Product, Description, Selling points, and reference notes as source facts for newly added copy; their written language does not need to be preserved when those fields become new canvas text. This permission never applies to text or graphics already visible on the physical product or packaging subject.",
    ...
    `Visible marketing text, captions, callouts, labels, and typography in the generated image must use ${targetLabel}, but this applies only to newly added canvas-level text outside the physical product or packaging subject.`,
    "Translate or rewrite wording from Product, Description, Selling points, and reference notes only when selecting it for new canvas-level marketing copy; preserve brand names, model names, numbers, and units exactly.",
    targetLanguage?.value === "en"
      ? "If source fields contain Chinese wording, do not render that Chinese wording or Chinese typography as visible image text from those fields; this rule does not apply to Chinese already printed or rendered on the physical product or packaging subject."
      : "",
  ]
    .filter(Boolean)
    .join(" ");
...
function buildCreationSuiteSplitGuidance(role, slotIndex, totalCount) {
  ...
  const functionalEffectAntiRedundancy =
    "For this functional effect rendering, use one unified product-led composition with one dominant, fully visible product and show every FUNCTION COVERAGE LOCK cue around it. If one frame cannot keep every cue legible, use a seamless continuous scene stitch around the same unchanged product with blended transitions and no hard borders. Do not use before-and-after, comparison, side-by-side, split-screen, paired-state, duplicate-product, or multi-panel layouts; do not use independent cards or comparison panels.";
  if (role === "effect-comparison") {
    return `${base} ${functionalEffectAntiRedundancy}`;
  }
...
function buildCreationConversionIntentGuidance(intent = {}) {
  ...
  const evidenceFocus = cleanString(intent.evidenceFocus);
  if (!audienceFocus && !motivationFocus && !objectionFocus && !conversionGoal) return "";
  return [
    `CONVERSION INTENT: Audience context: ${audienceFocus || "buyers evaluating this product category"}.`,
    conversionGoal ? `This image's distinct conversion job: ${conversionGoal}.` : "",
    motivationFocus ? `Purchase motivation to support: ${motivationFocus}.` : "",
    objectionFocus ? `Buyer uncertainty to reduce: ${objectionFocus}.` : "",
    evidenceFocus ? `Evidence focus: ${evidenceFocus}.` : "",
    "Use only supplied Product, Description, Selling points, dimensions, SKU, package, and reference-image evidence. Do not invent performance, certifications, prices, sales, guarantees, reviews, testimonials, ratings, or outcomes.",
  ].filter(Boolean).join(" ");
}

function replaceCreationConversionIntentGuidance(prompt, intent = {}) {
  const basePrompt = cleanString(prompt).replace(/\s*CONVERSION INTENT:[\s\S]*?Do not invent performance, certifications, prices, sales, guarantees, reviews, testimonials, ratings, or outcomes\./giu, " ").replace(/\s+/g, " ").trim();
...
function buildCreationPlatformItemOverrides(input = {}, profile = {}, selectedRoles = []) {
  ...
  for (const override of normalizeCreationPlatformItemOverrides(input.platformItemOverrides ?? input.itemOverrides ?? [])) {
    bySlotKey.set(override.slotKey, { ...(bySlotKey.get(override.slotKey) || {}), ...override });
  }
...
function buildCreationPlatformItemPolicyGuidance(platformPlan = {}, slot = {}) {
  const guidance = [
    ...
    "Use only supplied product input and attached reference evidence. Do not invent dimensions, materials, package contents, condition, defects, prices, certifications, sales, rankings, guarantees, reviews, or performance claims.",
    "Do not claim official platform approval or compliance; this plan is generation guidance and still requires user review.",
  ];
  if (slot.textPolicy === "none") {
    guidance.push("Render no added visible text or marketing copy.");
  }
  if (slot.logoPolicy === "forbid-overlay") {
    guidance.push(
      "Do not attach the user's uploaded external Logo. Preserve branding or identifiers already printed on the supplied product as part of product identity.",
    );
  }
  if (Array.isArray(slot.constraints) && slot.constraints.some((constraint) => constraint.level === "blocking")) {
    guidance.push(
      "Do not add visible marketing copy, badges, watermarks, collage panels, or scene insets; do not show accessories unless the supplied evidence proves they are included.",
    );
  }
  if (platformPlan.platform === "xiaohongshu") {
    guidance.push(
      "Do not fabricate reviews, engagement metrics, endorsements, or user testimony. Do not disguise brand-created content as UGC.",
    );
  }
  if (platformPlan.evidenceLevel === "C") {
    guidance.push("Treat this platform profile as editable conservative advice, not as an official requirement.");
  }
...
export function buildCreationPlan(input = {}) {
  ...
  if (legacyPlanningMode) {
    ...
    plannedRoles = applyCreationReferenceCoverageRolePlan(basePlannedRoles, referenceImageRoles).map((role, index) => ({
      ...
      platformSlot: {
        ...
        resolutionTier: platformSetOverrides.resolutionTier || "1.5K",
  ...
  const carouselItems = plannedRoles.map((role, index) => {
    ...
    const roleNeedsConversionIntent = ["hero", "benefit", "atmosphere", "effect-comparison"].includes(role.role);
    const canUseConversionRoleGuidance = roleNeedsConversionIntent && !platformPolicyDominant;
    const roleGuidance = platformPolicyDominant
      ? role.role === "effect-comparison"
        ? [getCreationRoleIntentInstruction(role.role), getCreationRoleRenderingConstraint(role.role)]
        : []
      : [
          getCreationShopperQuestionInstruction(role.role),
          getCreationBuyerDecisionInstruction(role.role),
          canUseConversionRoleGuidance || !platformNativeSlot ? getCreationRoleIntentInstruction(role.role) : "",
          ...
          buildCreationVisualLanguageGuidance(visualLanguage),
          canUseConversionRoleGuidance || !platformNativeSlot || ["spec-table", "accessory-gift"].includes(role.role)
    ...
    const generatedPrompt = [
      ...
      isDimensionRole
        ? buildCreationDimensionPromptInstruction({
            dimensionSpecSummary: role.role === "spec-table" ? keyDimensionSpecSummary : dimensionSpecSummary,
            dimensionUnitMode,
      ...
      buildCreationSubjectContentProtectionPrompt(),
      platformSlot.logoPolicy === "allow-supplied" ? buildCreationLogoGuidance(logoOptions) : "",
