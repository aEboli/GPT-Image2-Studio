...
export const MAX_PRODUCT_IMAGE_IMPORT_ITEMS = 1000;
export const MAX_PRODUCT_IMAGE_IMPORT_TEXT_BYTES = 4 * 1024 * 1024;
...
const MAX_PRODUCT_IMAGE_TITLE_LENGTH = 500;
...
export function normalizeProductImageImportManifest(rawManifest) {
  ...
  return {
    ...
    product: {
      ...
      title: stringWithin(rawManifest.product?.title, MAX_PRODUCT_IMAGE_TITLE_LENGTH)
        || `${getProductImagePlatformLabel(platform)} 商品`,
    },
