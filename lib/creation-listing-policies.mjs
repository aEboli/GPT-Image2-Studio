export const CREATION_LISTING_POLICY_VERSION = "listing-policy-2026-07-18.v3";
...
export const CREATION_LISTING_SOURCE_REGISTER = deepFreeze({
  ...
  "etsy-title-tags": source(
    ...
    "Etsy title and tag character and count limits, plus search guidance.",
  ),
  ...
  "coupang-product-creation": source(
    ...
    "Coupang product name, search tag count, and per-tag UTF-8 byte limits.",
  ),
});
...
export const CREATION_LISTING_ARCHETYPES = deepFreeze({
  ...
  search: {
    ...
    titlePattern: ["product-type", "model-or-variant", "key-factual-attribute"],
  ...
  editorial: {
    id: "editorial",
    conversionOrder: ["product-story", "craft-or-material-context", "factual-benefits", "details", "real-use-context", "gift-or-trust-context"],
...
const POLICY_DEFINITIONS = [
  ...
  definePolicy({
    id: "etsy", label: "Etsy", marketplaceId: "etsy", defaultLocale: "en-US", archetypeId: "editorial", evidenceLevel: "A",
    sourceIds: ["etsy-title-tags", "etsy-tag-guidance", "etsy-description-guidance"],
    titleRules: { hardMaxChars: 140, hardConstraintSourceIds: ["etsy-title-tags"], recommendationSourceIds: ["etsy-title-tags"] },
    descriptionRules: { recommendationSourceIds: ["etsy-description-guidance"] },
    searchRules: { label: "Tags", purpose: "Provide relevant Etsy tag candidates for review.", surface: "tags", publishable: true, hardMaxItems: 13, hardMaxCharsPerItem: 20, hardConstraintSourceIds: ["etsy-title-tags", "etsy-tag-guidance"], recommendationSourceIds: ["etsy-title-tags", "etsy-tag-guidance"] },
  }),
  definePolicy({
  ...
  definePolicy({
    id: "shopify", label: "Shopify/DTC", marketplaceId: "shopify", defaultLocale: "en-US", archetypeId: "editorial", evidenceLevel: "A", sourceIds: ["shopify-product-descriptions", "shopify-seo-keywords"],
  ...
  definePolicy({
    ...
    searchRules: { label: "검색 태그", surface: "search-tags", publishable: true, hardMaxItems: 20, hardMaxUtf8BytesPerItem: 20, hardConstraintSourceIds: ["coupang-product-creation"] },
  }),
