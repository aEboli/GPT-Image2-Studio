...
const CREATION_SUBJECT_CONTENT_PROTECTION_PROMPT =
  "Subject content: keep each supplied product or packaging subject as shown, with its artwork, symbols, logos, and printed text in the same characters, original language, placement, and colors. Added wording sits outside that subject; reference-card badges, prices, captions, and watermarks stay out.";
...
const CREATION_INFOGRAPHIC_REBUILD_BASE_PROMPT = [
  ...
  "GOAL: Rebuild the single attached source infographic as a clearly new, professionally designed infographic that reads as a fresh design at first glance.",
